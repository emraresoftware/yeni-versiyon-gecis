# Epic Migration Plan — Legacy → BOS

**Version:** 2.0 · **Task:** 022 · **Agent:** 6  
**Kaynak:** `DOMAIN_GAP_ANALYSIS.md`, `BUSINESS_RULE_MIGRATION_MATRIX.md`
...
## EPIC-LEG-022 — Unified Document Numbering

| Alan | Değer |
|------|-------|
| **Öncelik** | P0 |
| **Legacy** | Finance DocumentSeries + Elyafgroup NumberSequence |
| **BOS hedef** | `DocumentSeries` aggregate (prefix, reset, atomic) |
| **GAP** | İki paralel numara sistemi |

**Kapsam:** CR-/PR-/PO-/ST- serileri tek tenant-scoped service; yearly/monthly reset.

**Kabul kriterleri:**
- [ ] Concurrent issue test (Finance DocumentSeriesTest port)
- [ ] CrmProposal + PurchaseOrder aynı engine
- [ ] Conflict C-02 resolved

**Bağımlılık:** Platform kernel  
**Önerilen faz:** Faz 1 (Proposal ile)
