...
> **Kanonik standart:** [`MANDATORY_DOCUMENTATION_PROTOCOL.md`](MANDATORY_DOCUMENTATION_PROTOCOL.md) v1.0 — tüm ajanlar ve ekip için zorunlu.
...
| Architect Review | Chief Architect | `architect/ARCH_REVIEW_TASK_XXX.md` |
